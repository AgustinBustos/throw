    ...
    completion = client.beta.chat.completions.parse(
        ...
        messages=[
            {"role": "system", "content": '''I will give you a list of HTML elements 
             ...
             With respect to the answer, i want to get the job, so respond positevly, in general use 2 to 4 years of experience when asked, and the expected salary is 3000000'''},
            {"role": "user", "content": html},
        ],
